...
import com.pksoftware.feignservice.HRCollegeFeignClientService;
import com.pksoftware.feignservice.IDCollegeFeignClientService;
import com.pksoftware.feignservice.PKCollegeFeignClientService;
...
public class OfficeServiceImpl implements Microservices {
	...
	@Autowired
	PKCollegeFeignClientService pkCollegeFeignClient;
	
	@Autowired
	HRCollegeFeignClientService hrCollegeFeignClientService;
...
//		  RestTemplate t = new RestTemplate();
	...
	//H.R. College
	@Override
	public HRCollege hrCollegeDataByFeignClient(int id) {
		HRCollege hrCollege = hrCollegeFeignClientService.hrCollegeDataByFeignClient(id);
		return hrCollege;
	}
	...
	@Override
	public List<HRCollege> hrCollegeAllDataByFeignClient() {
		List<HRCollege> hrColleges = hrCollegeFeignClientService.hrCollegeAllDataByFiegnClient();
		return hrColleges;
	}
