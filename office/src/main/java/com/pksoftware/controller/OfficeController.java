...
public class OfficeController {
		...
		@GetMapping("/hrfeign/{id}")
		public HRCollege hrCollegeDataByFeignClient(@PathVariable int id) {
			   HRCollege hrCollege = microservices.hrCollegeDataByFeignClient(id);
			   return hrCollege;
		}
		@GetMapping("/hrallfeign")
		public List<HRCollege> hrCollegeAllDataByFeignClient(){
			   List<HRCollege> list = microservices.hrCollegeAllDataByFeignClient();
			   return list;
		}
}
